...
namespace Imago.Views.CustomControls
{
    ...
    public partial class AttributeExperienceDialogView : ContentView
    {
        ...
        public static readonly BindableProperty AttributeExperienceDialogViewModelProperty = BindableProperty.Create(
            ...
            typeof(AttributeExperienceDialogViewModel), // the bindable property type
            typeof(AttributeExperienceDialogView));

        public AttributeExperienceDialogViewModel AttributeExperienceDialogViewModel
        {
            get => (AttributeExperienceDialogViewModel) GetValue(AttributeExperienceDialogViewModelProperty);
        ...
        private void OnDragStarting(object sender, DragStartingEventArgs e)
        {
            ...
            {
                if (element.BindingContext is OpenAttributeExperienceViewModel viewModel)
                {
                    ResetDropHighlight(true);

                    e.Data.Properties.Add(nameof(OpenAttributeExperienceViewModel), viewModel);
        ...
        private void RemoveFromAll(OpenAttributeExperienceViewModel viewModel)
        {
        ...
        private void DropGestureRecognizer_OnDrop(object sender, DropEventArgs e)
        {
            if (sender is Element element)
            {
                ...
                var data =
                    e.Data.Properties[nameof(OpenAttributeExperienceViewModel)] as OpenAttributeExperienceViewModel;
        ...
        private ObservableCollection<OpenAttributeExperienceViewModel> GetItemSource(Element element)
        {
            if (element == Staerke)
