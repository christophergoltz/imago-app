...
{
    public class BodyPart : Util.BindableBase
    {
        private int _maxHitpoints;
        private int _currentHitpoints;
        private ObservableCollection<ArmorPartModel> _armor;
        private Enum.BodyPartType _type;

        public BodyPart(Enum.BodyPartType type, int currentHitpoints, ObservableCollection<ArmorPartModel> armor)
        {
            Type = type;
